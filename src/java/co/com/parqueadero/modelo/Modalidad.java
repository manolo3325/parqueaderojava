...
@NamedQueries({
    ...
    , @NamedQuery(name = "Modalidad.findByIdPlazo", query = "SELECT m FROM Modalidad m WHERE m.idPlazo = :idPlazo")
    , @NamedQuery(name = "Modalidad.findByFechaCorte", query = "SELECT m FROM Modalidad m WHERE m.fechaCorte = :fechaCorte")})
public class Modalidad implements Serializable {
    ...
    public Modalidad(Integer id, String nombre, boolean estado, int idPlazo, Date fechaCorte) {
        this.id = id;
        this.nombre = nombre;
        this.estado = estado;
    ...
    public String toString() {
        return "co.com.parqueadero.modelo.Modalidad[ id=" + id + " ]";
    }
